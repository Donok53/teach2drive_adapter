...
# Expert-only task adapter baseline.
# TF++ outputs are not used as supervision: output prior and feature drift are off.
...
export WORK_ROOT=${WORK_ROOT:-"$HOME/dataset/byeongjae/runs/tfpp_tesla_town13_expert_only_lora8_blend1"}
export OUT=${OUT:-"$WORK_ROOT/train_front_triplet_shifted_expert_only_lora8_blend1"}
