...
# ==============================================================================
# v4 = v3 but TARGETED: adapt ONLY the camera branch (image_encoder), freeze lidar (barely moved). Learning-only, no warp..
#
...
RUN_ROOT=${RUN_ROOT:-$HOME/dataset/byeongjae/runs/lora_pdm_lite_3h_v4_camera_branch}
