...
# Expert-only with stronger PEFT capacity around TF++ fusion/decoder/speed heads.
...
export WORK_ROOT=${WORK_ROOT:-"$HOME/dataset/byeongjae/runs/tfpp_tesla_town13_expert_only_lora16_head_blend1"}
export OUT=${OUT:-"$WORK_ROOT/train_front_triplet_shifted_expert_only_lora16_head_blend1"}
...
export LORA_ALPHA=${LORA_ALPHA:-32.0}
