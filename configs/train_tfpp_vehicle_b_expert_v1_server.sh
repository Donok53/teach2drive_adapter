...
SPEED_FLOOR_MASK=${SPEED_FLOOR_MASK:-moving}
SPEED_FLOOR_TARGET_THRESHOLD=${SPEED_FLOOR_TARGET_THRESHOLD:-2.0}
STOP_SPEED_CEILING_LOSS_WEIGHT=${STOP_SPEED_CEILING_LOSS_WEIGHT:-0.0}
HAZARD_STOP_SPEED_CEILING_LOSS_WEIGHT=${HAZARD_STOP_SPEED_CEILING_LOSS_WEIGHT:-0.0}
STOP_SPEED_CEILING_MPS=${STOP_SPEED_CEILING_MPS:-0.5}
STOP_SPEED_TARGET_THRESHOLD=${STOP_SPEED_TARGET_THRESHOLD:-0.5}
LAUNCH_CURRENT_SPEED_THRESHOLD=${LAUNCH_CURRENT_SPEED_THRESHOLD:-0.5}
LAUNCH_TARGET_SPEED_THRESHOLD=${LAUNCH_TARGET_SPEED_THRESHOLD:-2.0}
LAUNCH_SAMPLE_WEIGHT=${LAUNCH_SAMPLE_WEIGHT:-1.0}
LAUNCH_SPEED_FLOOR_LOSS_WEIGHT=${LAUNCH_SPEED_FLOOR_LOSS_WEIGHT:-0.0}
LAUNCH_SPEED_FLOOR_MPS=${LAUNCH_SPEED_FLOOR_MPS:-2.0}
LAUNCH_STOP_NEGATIVE=${LAUNCH_STOP_NEGATIVE:-0}
RELEASE_TARGET_SPEED_THRESHOLD=${RELEASE_TARGET_SPEED_THRESHOLD:-1.0}
RELEASE_SAMPLE_WEIGHT=${RELEASE_SAMPLE_WEIGHT:-1.0}
RELEASE_SPEED_FLOOR_LOSS_WEIGHT=${RELEASE_SPEED_FLOOR_LOSS_WEIGHT:-0.0}
RELEASE_SPEED_FLOOR_MPS=${RELEASE_SPEED_FLOOR_MPS:-2.0}
RELEASE_STOP_NEGATIVE=${RELEASE_STOP_NEGATIVE:-0}
...
CONTROL_LOSS_WEIGHT=${CONTROL_LOSS_WEIGHT:-0.0}
CONTROL_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT=${CONTROL_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT:-0.0}
CONTROL_LAUNCH_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT=${CONTROL_LAUNCH_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT:-0.0}
CONTROL_LAUNCH_THROTTLE_FLOOR_LOSS_WEIGHT=${CONTROL_LAUNCH_THROTTLE_FLOOR_LOSS_WEIGHT:-0.0}
CONTROL_RELEASE_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT=${CONTROL_RELEASE_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT:-0.0}
CONTROL_RELEASE_THROTTLE_FLOOR_LOSS_WEIGHT=${CONTROL_RELEASE_THROTTLE_FLOOR_LOSS_WEIGHT:-0.0}
CONTROL_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT=${CONTROL_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT:-0.0}
CONTROL_HAZARD_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT=${CONTROL_HAZARD_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT:-0.0}
CONTROL_BRAKE_OFF_MAX=${CONTROL_BRAKE_OFF_MAX:-0.10}
CONTROL_BRAKE_ON_MIN=${CONTROL_BRAKE_ON_MIN:-0.30}
CONTROL_BRAKE_ON_TARGET_THRESHOLD=${CONTROL_BRAKE_ON_TARGET_THRESHOLD:-0.20}
CONTROL_LAUNCH_THROTTLE_FLOOR=${CONTROL_LAUNCH_THROTTLE_FLOOR:-0.20}
CONTROL_RELEASE_THROTTLE_FLOOR=${CONTROL_RELEASE_THROTTLE_FLOOR:-0.20}
CONTROL_NO_BRAKE_TARGET_THRESHOLD=${CONTROL_NO_BRAKE_TARGET_THRESHOLD:-0.10}
...
PYTHONUNBUFFERED=1 "$PY" -m teach2drive_adapter.train_transfuserpp_cached_visual_adapter \
  ...
  --launch-stop-negative "$LAUNCH_STOP_NEGATIVE" \
  ...
  --release-stop-negative "$RELEASE_STOP_NEGATIVE" \
  ...
  --control-brake-false-positive-loss-weight "$CONTROL_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT" \
  --control-launch-brake-false-positive-loss-weight "$CONTROL_LAUNCH_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT" \
  --control-launch-throttle-floor-loss-weight "$CONTROL_LAUNCH_THROTTLE_FLOOR_LOSS_WEIGHT" \
  --control-release-brake-false-positive-loss-weight "$CONTROL_RELEASE_BRAKE_FALSE_POSITIVE_LOSS_WEIGHT" \
  --control-release-throttle-floor-loss-weight "$CONTROL_RELEASE_THROTTLE_FLOOR_LOSS_WEIGHT" \
  --control-brake-true-positive-loss-weight "$CONTROL_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT" \
  --control-hazard-brake-true-positive-loss-weight "$CONTROL_HAZARD_BRAKE_TRUE_POSITIVE_LOSS_WEIGHT" \
  --control-brake-off-max "$CONTROL_BRAKE_OFF_MAX" \
  --control-brake-on-min "$CONTROL_BRAKE_ON_MIN" \
  --control-brake-on-target-threshold "$CONTROL_BRAKE_ON_TARGET_THRESHOLD" \
  --control-launch-throttle-floor "$CONTROL_LAUNCH_THROTTLE_FLOOR" \
  --control-release-throttle-floor "$CONTROL_RELEASE_THROTTLE_FLOOR" \
  --control-no-brake-target-threshold "$CONTROL_NO_BRAKE_TARGET_THRESHOLD" \
