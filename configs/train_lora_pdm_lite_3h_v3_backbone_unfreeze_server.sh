...
# ==============================================================================
# v3 = v2 (anti-inertia + ego-speed aug) + PERCEPTION BACKBONE ADAPTATION.
#
...
# layer). v3 unfreezes the TF++ perception backbone (self.backbone = image+lidar
...
RUN_ROOT=${RUN_ROOT:-$HOME/dataset/byeongjae/runs/lora_pdm_lite_3h_v3_backbone_unfreeze}
...
export T2D_UNFREEZE_INCLUDE=${T2D_UNFREEZE_INCLUDE:-backbone}
