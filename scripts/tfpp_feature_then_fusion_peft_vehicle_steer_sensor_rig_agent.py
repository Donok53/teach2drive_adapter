#!/usr/bin/env python3
"""Shifted-rig feature adapter composed with the post-PID vehicle adapter."""
...
def get_entry_point() -> str:
    return "FeatureThenFusionPeftVehicleSteerSensorRigAgent"


class FeatureThenFusionPeftVehicleSteerSensorRigAgent(FeatureThenFusionPeftAdapterSensorRigAgent):
    ...
    def _load_vehicle_steer_adapter(self) -> None:
        ...
        self._vehicle_steer_adapter.load_state_dict(checkpoint["vehicle_steer_adapter_state"], strict=True)
        ...
        print(
            "[FeatureThenFusionPeftVehicleSteerSensorRigAgent] vehicle_adapter=on "
