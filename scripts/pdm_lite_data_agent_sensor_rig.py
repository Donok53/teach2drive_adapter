#!/usr/bin/env python3
"""PDM-Lite data collection agent with a Teach2Drive sensor rig override."""
...
class DataAgentSensorRig(DataAgent):
    ...
    def _apply_sensor_rig(self) -> None:
        ...
        print(
            "[DataAgentSensorRig] applied rig="
